...
public class DatabaseHelper extends SQLiteOpenHelper {
    public final static  String nama_db = "DB_Wisata";
//    public final static String nama_tabel = "User";
    ...
    public Boolean insertUser(String nama, String username,String email, String password){
        SQLiteDatabase db =this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
